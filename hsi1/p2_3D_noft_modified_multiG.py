...
results_base_model = '/home/data/zfl/results/results_from_scratch_modified_rerun.txt'
num_output = 1
batch_size = 8
num_epochs = 70
model_name_list = ['resnet3D_modified_2','resnet3D_modified_3','resnet3D_modified_4','resnet3D_modified_5']                   # 'C3D','squeezenet3D','shufflenet3D','mobilenet3D'
