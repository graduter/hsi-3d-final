...
def conv5x3x3(in_planes, out_planes, stride=1):
    return nn.Conv3d(in_planes,
                     out_planes,
                     kernel_size=(5,3,3),
                     stride=stride,
...
def conv7x1x1(in_planes, out_planes, stride=1):
    return nn.Conv3d(in_planes,
                     out_planes,
                     kernel_size=(7,1,1),
                     stride=stride,
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, downsample=None):
        ...
        self.conv2_2 = conv5x3x3(planes,int(planes/4))
        self.bn2_2 = nn.BatchNorm3d(int(planes/4))

        self.conv2_3 = conv7x1x1(planes, int(planes/4))
        self.bn2_3 = nn.BatchNorm3d(int(planes/4))

        self.conv2_4 = conv3x1x1(planes,int(planes/4))
