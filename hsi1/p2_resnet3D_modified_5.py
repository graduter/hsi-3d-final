...
def conv17x1x1(in_planes, out_planes, stride=1):
    return nn.Conv3d(in_planes,
                     out_planes,
                     kernel_size=(17,1,1),
                     stride=stride,
...
def conv33x1x1(in_planes, out_planes, stride=1):
    return nn.Conv3d(in_planes,
                     out_planes,
                     kernel_size=(33,1,1),
                     stride=stride,
...
class BasicBlock_2(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, downsample=None):
        ...
        self.conv1 = conv17x1x1(in_planes, planes, stride)
        self.bn1 = nn.BatchNorm3d(planes)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = conv17x1x1(planes, planes)
        self.bn2 = nn.BatchNorm3d(planes)
        self.downsample = downsample
        self.stride = stride
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block_1,block_2, planes, blocks, shortcut_type, stride=1):
        ...
        downsample_2 = nn.Sequential(
            conv33x1x1(self.in_planes, planes),
